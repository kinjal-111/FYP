              ...
              <Navbar expand="lg" className="grey-bg">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mr-auto">    
                        ...
                        <Nav.Link className="active" href="/admin/shipment">Shipment Details</Nav.Link>     
                  ...
                  <Col md={12}>
                    <div>
                        <div className="heading formheading">
                            <h3><FontAwesomeIcon id="formicon" icon={faTasks} style={{fontSize:"30px"}} />Shipment Details</h3>
                        </div>
                          ...
                          <Table striped bordered hover responsive>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><Button type="button" className="btn-ship">Ship now</Button></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Mohit Mishra</td>
